...
// UpdateFields 局部更新 Series 指定字段
func (r *SeriesRepo) UpdateFields(id string, fields map[string]interface{}) error {
	return r.db.Model(&model.Series{}).Where("id = ?", id).Updates(fields).Error
}
